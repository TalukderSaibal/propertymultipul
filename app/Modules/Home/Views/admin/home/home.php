     ...
     <div class="modal-dialog modal-dialog-centered modal-lg">
         <form class="modal-content">
             ...
             <div class="modal-body">
                 <div class="row">
                     ...
                     <div class="col-md-6 mt-4">
                         ...
                         <p class="text-danger"><?php if (isset($validation)) {
             ...
             <div class="modal-footer">
                 <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><?php echo lang('admin/rent.cancel'); ?></button>
                 <button type="button" class="btn btn-primary submitRent"><?php echo lang('admin/rent.created'); ?></button>
             </div>
         </form>
     </div>
 </div>
