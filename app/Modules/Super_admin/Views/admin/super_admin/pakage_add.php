                        ...
                        <form action="<?= base_url('admin/pakage_add') ?>" method="POST" enctype="multipart/form-data"  class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-4">
                                    ...
                                    <div class="valid-feedback"><?php echo lang('admin/super_admin.Looks good!'); ?></div>
                                    <p style="color:red;" class="text-danger"><?php if (isset($validation)) {
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <label class="days_view" style="display: none;"><?php echo lang('admin/super_admin.* How many :'); ?></label>
                                    <input id="how_many" class="days_view form-control" style="display: none;" type="number" name="how_many">
                                </div>

                                <div class="col-md-6 mt-4">
                                    <label class="days_view" style="display: none;"><?php echo lang('admin/super_admin.* Select Type :'); ?></label>
